...
>
    ...
    <div class="flex gap-2">
        <input
            ...
            class="flex-1 min-w-0 px-3 py-1.5 text-sm border border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-white rounded-lg focus:outline-none focus:ring-1 focus:ring-amber-500 focus:border-amber-500"
        >
        <button
            type="button"
            @click="useMyLocation()"
        ...
        <button
            ...
            class="bg-amber-500 hover:bg-amber-700 disabled:opacity-50 text-white text-sm font-semibold py-1.5 px-3 rounded-lg transition whitespace-nowrap"
        >
