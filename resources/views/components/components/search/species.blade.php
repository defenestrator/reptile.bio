			...
			<div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
				<div class="p-4 bg-white border-b border-gray-200">
					...
					<table class="shadow-lg">
						...
						<tbody>
							<template x-for="taxon in filteredUsers" :key="taxon.id">
								<tr>
									<td x-text="taxon.id" class="border px-4 py-1 text-center"></td>
									<td x-text="taxon.name" class="border px-4 py-1"></td>
									<td x-text="taxon.email" class="border px-4 py-1"></td>
								</tr>
							</template>
						</tbody>
					</table>
