<x-mail-layout>
    <div style="margin-bottom: 24px;">
        ...
        <p style="color: #6b7280; margin: 0;">Someone has inquired about a classified listing.</p>
    </div>
    ...
    <table style="width: 100%; margin-bottom: 24px;">
        <tr>
            <td style="padding: 8px 0; color: #555; width: 40%;"><strong>Classified:</strong></td>
            <td style="padding: 8px 0; color: #111827;">{{ $classified->title }}</td>
        </tr>
        <tr>
    ...
    <table style="width: 100%;">
        <tr>
            ...
            <td style="padding-left: 8px;">
                <a href="mailto:{{ $inquiry->email }}?subject=Re: Inquiry about {{ $classified->title }}"
